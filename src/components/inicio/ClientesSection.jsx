  ...
  const testimonios = [
    {
      ...
      testimonio: "Con Sud hemos podido recuperar unidades por robo y además con su software Ananta y Varuna, sus controles logísticos y administrativos han sido de gran ayuda en la empresa.",
      destacado: true
    },
    {
      ...
      testimonio: "Sud Solutions es una empresa profesional. Nos gusta que están disponibles las 24 horas, no solo para emergencias, sino también para resolver dudas sobre la plataforma. Se integró la plataforma de rastreo con su software Ananta, y hemos logrado mejorar en el control de gastos.",
      destacado: false
    },
    {
      ...
      testimonio: "Hemos probado otros productos y servicios, pero con Sud logramos encontrar un proveedor profesional, con un servicio de calidad. Vale la pena cada peso que se paga con ellos. Su servicio de 24hrs, de Dashcam IA y Desarrollo de Software, son sin duda el punto de lanza.",
      destacado: true
    }
  ];
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonios.map((testimonio, index) => (
            ...
            >
              {/* Efecto de gradiente */}
              <div className="absolute -inset-4 bg-gradient-to-r from-[#326a10] to-secondary rounded-2xl opacity-0 hover:opacity-10 blur-xl transition-opacity duration-500 z-0"></div>
