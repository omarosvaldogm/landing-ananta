    ...
    <div className="bg-[#0a0a0a] min-h-screen flex flex-col items-center justify-between overflow-hidden relative">
      ...
      >
        ...
        >
          ...
          >
            <span className='text-white'>Guías</span> Prácticas
          </motion.h1>
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Descubre nuestras guías prácticas para maximizar el uso de Ananta ERP y llevar tu negocio al siguiente nivel.
          </motion.p>
        </motion.div>
