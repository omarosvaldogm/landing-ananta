        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to={'/'} className="text-gray-400 hover:text-[#9BBF5F] transition-colors">Inicio</Link></li>
              <li><Link to={'/nosotros'} className="text-gray-400 hover:text-[#9BBF5F] transition-colors">Nosotros</Link></li>
              <li><Link to={'/ananta'} className="text-gray-400 hover:text-[#9BBF5F] transition-colors">Ananta</Link></li>
              <li><Link to={'/contacto'} className="text-gray-400 hover:text-[#9BBF5F] transition-colors">Contacto</Link></li>
              <li><Link to={'/'} className="text-gray-400 hover:text-[#9BBF5F] transition-colors">Iniciar Sesión</Link></li>
            </ul>
          </div>
